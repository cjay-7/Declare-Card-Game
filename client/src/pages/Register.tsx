        ...
        <Card.Body className="px-8 pt-6">
          <form onSubmit={handleSubmit} className="space-y-5" noValidate>
            ...
            <div>
              ...
              <div className="mt-2">
                <Progress value={passwordStrength} color={passwordStrength >= 100 ? "success" : "primary"} size="sm" className="h-1">
                  <Progress.Bar />
                </Progress>
                <Typography id="password-hint" className="text-xs mt-1" style={{ color: "var(--on-surface-variant)" }}>
